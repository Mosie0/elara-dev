...
module.exports.run = async (bot, message, args) => {
    let botembed = new Discord.RichEmbed()
        ...
        .addField(`Info`, '`avatar`, `bothelp`, `botinfo`, `color`, `emojis`, `help`, `id`, `members <rolename>`, `math`, `membercount`, `npm`, `ping`, `roleinfo`, `roles`, `channels`, `serverinfo`, `Invite`, `stats`, `topinvites`, `weather`, `whois`')
